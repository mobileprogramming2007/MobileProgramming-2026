...
import com.example.mobileprogramminglabs.presentation.view_model.habit.edit_habit.EditHabitNavigationEvent
import com.example.mobileprogramminglabs.presentation.view_model.habit.edit_habit.EditHabitUiState
import com.example.mobileprogramminglabs.presentation.view_model.habit.edit_habit.EditHabitViewModel
...
fun EditHabitScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.navigationEvent.collect { event ->
            when (event) {
                EditHabitNavigationEvent.NavigateBack -> onNavigateBack()
            }
        }
    }
    ...
    LaunchedEffect(uiState) {
        val state = uiState
        if (state is EditHabitUiState.Success) {
            title = state.title
